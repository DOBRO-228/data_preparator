...
def get_indices_and_info_from_errors(errors: ValidationError) -> dict:
    ...
    for error in errors.errors():
        ...
        if row_index_with_error not in indexes_and_errors_of_rows_with_invalid_data:
            indexes_and_errors_of_rows_with_invalid_data[row_index_with_error] = [{column_name_with_error: error_message}]
        else:
            indexes_and_errors_of_rows_with_invalid_data[row_index_with_error].append({column_name_with_error: error_message})
